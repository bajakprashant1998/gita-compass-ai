        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground max-w-sm">
              ...
              modern life, powered by timeless wisdom.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-muted-foreground">
              <li>
                <Link to="/chapters" className="hover:text-foreground transition-colors">
                  All Chapters
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-muted-foreground">
              ...
              <li>
                <Link to="/dashboard/favorites" className="hover:text-foreground transition-colors">
                  Saved Wisdom
                </Link>
              </li>
            </ul>
