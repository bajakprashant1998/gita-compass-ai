...
function MegaMenuPanel({
  ...
  if (type === 'chapters') {
    return (
      <div
        className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-[760px] max-w-[92vw] bg-card/98 backdrop-blur-2xl border border-border/40 rounded-2xl shadow-2xl shadow-primary/8 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150 z-[60]"
