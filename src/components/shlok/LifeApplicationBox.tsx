        ...
        <Card className="metric-card border-2 border-primary/20 hover:border-primary/40 transition-all duration-300">
          <CardContent className="p-5 sm:p-6 md:p-8">
            <div className="flex items-start gap-4 sm:gap-5">
              <div className="shrink-0 p-3 sm:p-4 rounded-2xl bg-gradient-to-br from-primary to-amber-500 text-white shadow-lg glow-primary">
              ...
              <div className="flex-1">
                ...
                <p className="text-base sm:text-lg md:text-xl leading-relaxed font-medium text-foreground">
                  {shlok.life_application}
                </p>
              </div>
            </div>
