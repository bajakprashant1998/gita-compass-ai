...
const WhatsAppIcon = forwardRef<SVGSVGElement>((_, ref) => (
  <svg ref={ref} className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <div className={`flex flex-wrap gap-2 ${className}`}>
      <Button
        ...
        className="gap-2 hover:bg-green-50 hover:text-green-700 hover:border-green-300 dark:hover:bg-green-950/30 dark:hover:text-green-400"
      >
        <WhatsAppIcon />
        WhatsApp
      </Button>
