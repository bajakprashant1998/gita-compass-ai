  ...
  public: {
    Tables: {
      ...
      study_groups: {
        ...
        Relationships: [
          {
            foreignKeyName: "study_groups_creator_id_profiles_fkey"
            columns: ["creator_id"]
            isOneToOne: false
      ...
      verse_discussions: {
        ...
        Relationships: [
          {
            foreignKeyName: "verse_discussions_parent_id_fkey"
            columns: ["parent_id"]
            isOneToOne: false
            referencedRelation: "verse_discussions"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "verse_discussions_shlok_id_fkey"
            columns: ["shlok_id"]
            isOneToOne: false
            referencedRelation: "shloks"
            referencedColumns: ["id"]
